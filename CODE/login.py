...
st.markdown(f'<h1 style="color:#000000 ;text-align: center;font-size:26px;font-family:verdana;">{"Health Monitoring System Using ML and IOT"}</h1>', unsafe_allow_html=True)
